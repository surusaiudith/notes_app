...
const validateNote=require('../middleware/validateNote');//import validation function
router.post('/',validateNote,(req,res)=>{//to post a new note and check for any errors using middleware
